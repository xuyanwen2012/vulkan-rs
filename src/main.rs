...
fn main() {
    ...
    println!(
        "Using device: {}",
        physical_device.properties().device_name.trim_matches('\0')
    );
    ...
    // create a vec of glm::float4 type
    // let source_content: Vec<glm::Vec4> = (0..64)
    // .map(|i| glm::vec4(i as f32, i as f32, i as f32, i as f32))
    // .collect();
